    ...
    <Layout>
      <section className="relative min-h-[70vh] flex items-center overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 py-24">
          ...
          <h1 className="text-5xl md:text-7xl font-display font-bold leading-[1.05] mb-6 max-w-3xl">Super Car <span className="text-gradient-brand">Detailing</span></h1>
      ...
      <section className="container mx-auto px-6 py-24">
        <div className="rounded-2xl bg-card border border-border p-10 md:p-16 text-center">
          <h2 className="text-4xl md:text-5xl font-display font-bold mb-4">Drive something <span className="text-gradient-brand">special?</span></h2>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a href="tel:8623301276" className="inline-flex items-center gap-2 px-6 py-3 rounded-md bg-gradient-brand text-primary-foreground font-semibold shadow-brand hover:opacity-95 transition-opacity"><Phone className="h-4 w-4" /> (862) 330-1276</a>
