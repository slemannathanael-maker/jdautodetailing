      ...
      <header className="sticky top-0 z-50 backdrop-blur-xl bg-background/90 border-b border-border">
        <nav className="container mx-auto px-6 py-4 flex items-center justify-between gap-3">
          <Link to="/" className="flex items-center gap-3 min-w-0">
            <img src={logoAsset.url} alt="JD Auto Detailing logo" className="h-12 w-12 rounded-full object-cover" loading="eager" />
          ...
          <div className="flex items-center gap-1 sm:gap-3">
            ...
            <Link to="/supercars" className="px-3 py-2 text-sm font-medium hover:text-brand-blue transition-colors" activeProps={{ className: "text-brand-blue" }}>Super Cars</Link>
        ...
        <div className="container mx-auto px-6 py-12 grid gap-8 md:grid-cols-3">
          <div>
            <div className="flex items-center gap-3 mb-3">
              <img src={logoAsset.url} alt="" className="h-10 w-10 rounded-full object-cover" />
